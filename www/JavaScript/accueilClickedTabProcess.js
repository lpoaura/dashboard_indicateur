...
$(document).ready(function () {
  ...
  $(function () {
    const onClick = (event) => {
      ...
      if ((event.target.nodeName === 'BUTTON' && event.target.className!=="btn btn-default action-button shiny-bound-input") || event.target.className === 'labelMultipleInd' || event.target.parentElement.className === 'labelMultipleInd') {
