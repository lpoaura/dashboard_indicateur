...
listIdTabAccueil <- list("ind1","ind2","ind21","ind22","ind23","ind3")
listDivTabAccueil <- list(divInfo_ind1,divInfo_ind2,divInfo_ind21,divInfo_ind22,divInfo_ind23,divInfo_ind3)
